<template>
  <el-dialog :title="title" :visible.sync="showStart" append-to-body @opened="startOpenDialogCallBack">
    <div class="dialog-footers">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="流程名称" prop="name">
              <el-select v-model="form.flowDate.name  " placeholder="请选择流程" @change="selectFlowType">
                <el-option
    ...
    methods: {
      ...
      submitForm() {
        ...
        startFlow(data).then(response => {
          ...
          this.reset()
          this.$emit("startFlowCallBack",success,orderId)
        })
      },
      showModal(orgId, type,businessId) {
        debugger
        this.showStart = true
      ...
      startOpenDialogCallBack(){
        this.$emit("openStartDialogCallBack")
      }
    }
  }
</script>
