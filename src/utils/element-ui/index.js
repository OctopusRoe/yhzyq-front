...
const install = function(Vue, opts = {}) {
  ...
  window.$loading = Vue.prototype.$loading = Loading.service;
  window.$msgbox = Vue.prototype.$msgbox = MessageBox;
  window.$alert = Vue.prototype.$alert = MessageBox.alert;
  window.$confirm = Vue.prototype.$confirm = MessageBox.confirm;
  window.$prompt = Vue.prototype.$prompt = MessageBox.prompt;
  window.$notify = Vue.prototype.$notify = Notification;
