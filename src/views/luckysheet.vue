  ...
  <div class="app-container">
    <el-row>
      <el-col :span="24" :xs="24">
        ...
        <button @click="addFormula" style="margin: 0 20px">自定义公式</button>
        <button @click="downloadExcel" style="margin: 0 20px">前端下载</button>
        <button @click="downloadExcel2" style="margin: 0 20px">后端下载</button>
        ...
        <el-dialog title="自定义弹出框" :visible.sync="dialogOpen" width="60%" append-to-body="append-to-body">
