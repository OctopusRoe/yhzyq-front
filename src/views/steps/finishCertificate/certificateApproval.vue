        ...
        <div>
          ...
          >
            ...
            <vxe-table-colgroup title="清单">
              ...
              ></vxe-table-column>
              <!--实际为 申报数量 -->
              <vxe-table-column field="applyNumber" title="申报数量">
              </vxe-table-column>
              <vxe-table-column field="checkNumber" title="核定数量">
                <template slot-scope="scope">
                  <vxe-input
                    type="number"
                    min="0"
                    :max="scope.row.checkNumber"
                    v-model="scope.row.checkNumber"
                    :disabled="scope.row.checkNumber === 0"
                  ></vxe-input>
...
export default {
  name: "",
  components: { UploadManageFrame, ExamineFlow },
  data() {
    return {
