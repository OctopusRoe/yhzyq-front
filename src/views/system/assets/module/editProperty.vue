...
<script>
import { updateData } from "@/api/system/assets/index";
...
export default {
  ...
  methods: {
    ...
    showModal(record, propertyData) {
      this.form = { ...record };
      console.log("this.form.extConfigTypeId:" + this.form.extConfigTypeId);
      this.propertyData = propertyData;
      this.queryConfigType(this.form.extConfigTypeId);
