...
<script>
import { saveData } from "@/api/system/extConfig/index";
export default {
  name: "addExtConfig",
  components: {},
  props: {
  ...
  methods: {
    ...
    addDropDown() {
      this.form.dropdowns.push({
        ...
        name: "",
        defaultvalue: "",
        sortedNum: this.form.dropdowns.length + 1
      });
    },
    ...
    showModal(extConfigTypeId, propertyData) {
      this.form.extConfigTypeId = extConfigTypeId;
      this.propertyData = propertyData;
      //默认第一个，都是否
      this.form.needed = this.propertyData.sfneed[0].vals;
      this.form.readOnly = this.propertyData.sfzd[0].vals;
      this.form.forbided = this.propertyData.sfjz[0].vals;
      //排序默认0
