        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="父机构" prop="parentId">
              <treeselect v-model="form.parentId" :options="pidOptions"
                          :normalizer="normalizer" :show-count="true" placeholder="请选择父机构" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="第一负责人" prop="principal">
              <el-select v-model="form.principal" placeholder="第一负责人" clearable size="small">
                <el-option
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="机构组织类型" prop="organizationType">
              <el-select v-model="form.organizationType" placeholder="机构组织类型" clearable size="small">
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="机构业务类型" prop="buzType">
              <el-select v-model="form.buzType" placeholder="机构业务类型" clearable size="small">
                <el-option
